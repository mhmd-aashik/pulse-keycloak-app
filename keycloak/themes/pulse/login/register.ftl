...
<@layout.registrationLayout displayMessage=messagesPerField.exists('global') displayRequiredFields=true; section>
    <#if section = "header">
        ...
        <p class="pulse-register-subtitle">${msg("registerTitle")}</p>
    <#elseif section = "form">
        <form id="kc-register-form" class="pulse-form" action="${url.registrationAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    <input class="pulse-btn pulse-btn--primary" type="submit" value="${msg("doRegister")}"/>
                </div>
            </div>
        </form>
